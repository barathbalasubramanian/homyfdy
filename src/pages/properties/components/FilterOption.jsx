        ...
        >
          ...
          <div className="flex-1">
            <select
              ...
              className="flex outline-none gap-3 items-center px-5 py-2 pl-2 border-none w-full text-sm font-medium leading-none rounded-md border border-solid text-stone-500 appearance-none"
            >
