...
function FeaturedProperties1({property, buttons1, setbuttonValue1, number}) {
            ...
            <div className='py-6 flex items-center gap-8 justify-between text-start max-md:flex-col max-md:items-start max-md:pb-10'>
              {
                ...
                <div>
                    ...
                    <div style={{color:"grey"}} className='w-3/4'>Explore our handpicked selection of featured properties. Each listing offers a glimpse into exceptional homes and investments available through Estatein. Click "View Details" for more information.</div>
                </div>
              }
