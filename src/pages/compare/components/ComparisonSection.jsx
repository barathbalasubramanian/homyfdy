...
function ComparisonSection({ properties }) {
  ...
  const excludedKeys = ['imageLinks', 'id', 'additionalFeatures', 'Brochurelink', 'amenities', 'MainImage', "propertyReliable", "brochurelink", "addressLink"];
